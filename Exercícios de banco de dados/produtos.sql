create database GigaByteDB_Edimilson;
...
where categoria like 'Hardware' and quantidade_estoque > 0 order by preco asc limit 3;

#Relatorio 2
select sku, nome_produto from produtos 
