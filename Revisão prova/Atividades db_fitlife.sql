...
-- comando UPDATE para alterar o campo cidade deste usuário para 'São Paulo'. (Dica:
...
-- junto com o tipo_exercicio que ele realizou. (Dica: Use INNER JOIN entre as tabelas usuarios e
-- atividades).
